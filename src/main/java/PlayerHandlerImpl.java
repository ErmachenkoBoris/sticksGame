...
public class PlayerHandlerImpl extends UnicastRemoteObject
        implements PlayerHandler {
    private static List<Handler> clients;

    private List<Player> players;

    public PlayerHandlerImpl() throws RemoteException {
        super();
    ...
    public void addNewPlayer(Player player) throws RemoteException {
        players.add(player);
            try {
                ...
                Handler h;
                h = (Handler) registry.lookup("Handler");
               clients.add(h);
            } catch (Exception e) {
            }
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            PlayerHandler service = new PlayerHandlerImpl();

            String serviceName = "PlayerHandler";
